...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/daddyfrrr")]])
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](https://t.me/daddyfrrr)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
